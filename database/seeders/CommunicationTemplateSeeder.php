...
class CommunicationTemplateSeeder extends Seeder
{
    ...
    <p>فريق {center_name}</p>
            ...
            // Employee Invitation
            [
                'code' => 'employee_invitation',
                'name' => 'دعوة موظف جديد',
                'type' => 'email',
                'subject' => 'مرحباً بك في الفريق - تفعيل حسابك في {app_name}',
                'content' => '<div style="font-family: sans-serif; text-align: right; direction: rtl; max-width: 600px; margin: 0 auto; background: #fff; padding: 40px; border-radius: 12px;">
    <div style="text-align: center; margin-bottom: 30px;">
        <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%); border-radius: 50%; margin: 0 auto 20px; text-align: center; line-height: 80px;">
            <span style="font-size: 36px;">👋</span>
        </div>
        <h1 style="color: #111827; font-size: 24px; margin: 0;">مرحباً بك في الفريق!</h1>
        <p style="color: #6b7280; margin: 5px 0 0;">تم إنشاء حساب لك في النظام</p>
    </div>
    ...
    <p style="color: #374151; font-size: 16px; line-height: 1.8;">
        تم إضافتك كموظف في نظام <strong>{app_name}</strong>.
        يرجى الضغط على الزر أدناه لتفعيل حسابك وتعيين كلمة المرور الخاصة بك.
    </p>
    
    <div style="text-align: center; margin: 30px 0;">
        <a href="{activation_url}" style="display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%); color: #ffffff; text-decoration: none; border-radius: 10px; font-weight: bold; font-size: 16px;">تفعيل الحساب وتعيين كلمة المرور</a>
    </div>
