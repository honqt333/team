...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('sms_packages', function (Blueprint $table) {
            ...
            $table->decimal('price_per_sms', 8, 4)->virtualAs('price / credits');
        ...
        Schema::create('sms_usage_logs', function (Blueprint $table) {
            ...
            $table->string('message_type'); // reminder, notification, otp, marketing
            $table->integer('credits_used')->default(1);
            $table->string('provider')->nullable(); // unifonic, twilio, etc
