                    ...
                    <div class="relative z-10 flex flex-col h-full p-6 pb-8">
                        ...
                        <div class="flex items-start justify-between gap-4 mb-4">
                            <div class="min-w-0">
                                ...
                                <div v-if="(customer.type === 'company' || customer.type === 'government') && customer.contact_name" class="mt-2.5 flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-indigo-50/50 dark:bg-indigo-900/30 border border-indigo-100/50 dark:border-indigo-800/30">
                        ...
                        <!-- 3. Contact Box -->
                        <div class="mb-4">
                            <a :href="`tel:${customer.phone}`" @click.stop class="flex items-center gap-3 px-3 py-1.5 rounded-2xl bg-indigo-50/30 dark:bg-indigo-900/10 border border-indigo-100/30 dark:border-indigo-800/30 hover:border-indigo-400 group-hover:border-indigo-400 transition-colors mb-2">
                                <div class="w-7 h-7 rounded-xl bg-white dark:bg-gray-800 flex items-center justify-center shadow-sm border border-gray-100 dark:border-gray-700">
                                ...
                                <span class="text-[13px] font-black text-gray-800 dark:text-gray-200 tracking-widest" dir="ltr">{{ customer.phone }}</span>
                            </a>
                            <a v-if="customer.email" :href="`mailto:${customer.email}`" @click.stop class="flex items-center gap-3 px-3 py-1.5 rounded-2xl bg-purple-50/30 dark:bg-purple-900/10 border border-purple-100/30 dark:border-purple-800/30 hover:border-purple-400 group-hover:border-purple-400 transition-colors">
                                <div class="w-7 h-7 rounded-xl bg-white dark:bg-gray-800 flex items-center justify-center shadow-sm border border-gray-100 dark:border-gray-700">
                                    <svg class="w-3.5 h-3.5 text-gray-400 group-hover:text-purple-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                </div>
                                <span class="text-[11px] font-black text-gray-800 dark:text-gray-200 truncate">{{ customer.email }}</span>
                            </a>
                        </div>
