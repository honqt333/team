        ...
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <form @submit.prevent="submit" class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 bg-blue-50/40 dark:bg-blue-900/10 p-5 rounded-2xl border border-blue-100 dark:border-blue-800/30">
                        <!-- وحدة الشراء -->
                        <div>
                            <SearchableSelect
                                v-model="form.purchase_unit_id"
                                :options="unitOptions"
                                :label="$t('purchasing.items.purchase_unit')"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 font-mono disabled:opacity-50 disabled:cursor-not-allowed"
                                    placeholder="1"
                                />
                            </div>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
...
const form = useForm({
    ...
    purchase_unit_id: props.part?.purchase_unit_id || '',
    purchase_conversion_factor: parseFloat(props.part?.purchase_conversion_factor) || 1,
