<template>
    <DialogModal :show="show" @close="handleClose" max-width="5xl">
        <template #title>
        ...
        <template #content>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <!-- Right Column: Image and Collapsibles -->
                <div class="space-y-6 lg:border-l lg:dark:border-gray-700 lg:pl-6 rtl:lg:border-l-0 rtl:lg:border-r rtl:lg:pr-6">
                    <!-- Image Upload Section -->
                    <div class="flex flex-col items-center justify-center p-5 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-3xl bg-gray-50/50 dark:bg-gray-900/30 transition-all hover:bg-gray-100 dark:hover:bg-gray-800/50 group relative overflow-hidden">
                        <input
                            type="file"
                            ref="imageInput"
                            class="hidden"
                        ...
                        <div v-if="imagePreview" class="relative group/preview">
                            <img :src="imagePreview" class="w-24 h-24 object-cover rounded-2xl shadow-xl border-4 border-white dark:border-gray-800 transition-transform group-hover/preview:scale-105" />
                            <button 
                                @click="removeImage"
                        ...
                        <div v-else @click="imageInput.click()" class="flex flex-col items-center cursor-pointer">
                            <div class="w-12 h-12 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                            </div>
                            <span class="text-xs font-bold text-gray-600 dark:text-gray-400">{{ $t('inventory.parts.add_image') || 'Add Part Image' }}</span>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700">
                            ...
                            <div v-show="sections.pricing" class="px-4 py-4 border-t border-gray-100 dark:border-gray-700">
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <!-- Active Toggle -->
                                    <div class="flex items-center justify-between p-2 border border-gray-200 dark:border-gray-600 rounded-lg">
                                        <span class="text-xs font-medium text-gray-700 dark:text-gray-300">{{ $t('common.active') }}</span>
                                        <button 
                                            type="button" 
