            ...
            >
                ...
                <div class="px-6 pb-6 -mt-12">
                    <div class="flex flex-col sm:flex-row items-start sm:items-end gap-4">
                        <div
                            class="w-24 h-24 rounded-2xl bg-white dark:bg-gray-700 border-4 border-white dark:border-gray-800 flex items-center justify-center text-3xl font-bold text-violet-600 dark:text-violet-400 shadow-lg overflow-hidden"
                        >
                            <img
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">
                            {{ $t('employee_portal.personal_info') }}
                        </h3>
                    </div>
                    <dl class="space-y-4">
                        <div
                            class="flex justify-between py-3 border-b border-gray-100 dark:border-gray-700"
                        >
                            <dt class="text-sm text-gray-500 dark:text-gray-400">
                                {{ $t('hr.employees.employee_number') }}
                            </dt>
                        ...
                        >
                            ...
                            <dd class="text-sm font-medium text-gray-900 dark:text-white" dir="ltr">
                                {{ employee?.email || '-' }}
                            </dd>
                        </div>
                        <div
                ...
                >
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">
                            {{ $t('employee_portal.job_info') }}
                        </h3>
                    </div>
                    <dl class="space-y-4">
                        <div
                            v-if="employee?.job_title"
                            class="flex justify-between py-3 border-b border-gray-100 dark:border-gray-700"
                        >
                            <dt class="text-sm text-gray-500 dark:text-gray-400">
                                {{ $t('hr.employees.job_title') }}
                            </dt>
                            <dd class="text-sm font-medium text-gray-900 dark:text-white">
                        ...
                        <div
                            v-if="employee?.center"
                            class="flex justify-between py-3 border-b border-gray-100 dark:border-gray-700"
                        >
                            <dt class="text-sm text-gray-500 dark:text-gray-400">
                                {{ $t('hr.employees.branch') }}
                            </dt>
                            <dd class="text-sm font-medium text-gray-900 dark:text-white">
                        ...
                        <div v-if="employee?.default_shift" class="flex justify-between py-3">
                            <dt class="text-sm text-gray-500 dark:text-gray-400">
                                {{ $t('hr.settings.shifts.shift') }}
                            </dt>
                            <dd class="text-sm font-medium text-gray-900 dark:text-white">
                                {{ employee?.default_shift?.name_ar }}
                            </dd>
                        </div>
                    </dl>
                </div>
