...
const form = useForm({
    settings: {
        ...
        website_social_links: props.settings.website_social_links || [],
    }
});
                        ...
                        <div v-if="activeTab === 'seo_social'" class="space-y-10">
                            ...
                            <div class="pt-8 border-t border-gray-200">
                                <div class="flex items-center justify-between mb-6">
                                    ...
                                    <button @click="addItem('website_social_links', { platform: 'facebook', url: '' })" class="btn-outline text-xs py-1.5">إضافة شبكة</button>
                                </div>
                                
                                <div class="space-y-4">
                                    <div v-for="(link, index) in form.settings.website_social_links" :key="index" class="p-4 border border-gray-100 dark:border-gray-700 rounded-xl bg-gray-50/30 dark:bg-gray-800/30 group">
                                    ...
                                    <div v-if="!form.settings.website_social_links || !form.settings.website_social_links.length" class="text-center py-10 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl text-gray-500">
