    ...
    <SystemLayout>
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 text-center"
                >
                    <div
                        class="w-10 h-10 mx-auto bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mb-2"
                    >
                        <svg
                ...
                >
                    <div
                        class="w-10 h-10 mx-auto bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center mb-2"
                    >
                        <svg
                ...
                >
                    <div
                        class="w-10 h-10 mx-auto bg-emerald-100 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center mb-2"
                    >
                        <svg
                ...
                >
                    <div
                        class="w-10 h-10 mx-auto bg-amber-100 dark:bg-amber-900/30 rounded-lg flex items-center justify-center mb-2"
                    >
                        <svg
                ...
                >
                    <div
                        class="w-10 h-10 mx-auto bg-indigo-100 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center mb-2"
                    >
                        <svg
                ...
                >
                    <div
                        class="w-10 h-10 mx-auto bg-rose-100 dark:bg-rose-900/30 rounded-lg flex items-center justify-center mb-2"
                    >
                        <svg
                ...
                >
                    <div
                        class="w-10 h-10 mx-auto bg-cyan-100 dark:bg-cyan-900/30 rounded-lg flex items-center justify-center mb-2"
                    >
                        <svg
                        ...
                        <div class="mb-4">
                            ...
                            <div v-if="securityForm.two_factor_enabled">
                                ...
                                <p class="text-xs text-gray-500 mt-2">
                                    يحدد هذا الإعداد ما إذا كان يجب على مستخدمي المستأجر تفعيل
                                    المصادقة الثنائية.
                                </p>
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                >
                    ...
                    >
                        ...
                        <ul
                            class="mt-2 text-sm text-red-600 dark:text-red-400 list-disc list-inside"
                        >
...
const twoFactorEnforcementOptions = computed(() => [
