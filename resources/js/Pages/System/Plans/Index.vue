            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div
                        ...
                        class="absolute top-4 left-4 px-2 py-1 bg-indigo-600 text-white text-xs font-medium rounded-full"
                    >
                        مميزة
                    </div>
                    ...
                    <div class="p-6 pt-12">
                        ...
                        <div class="mt-6">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                ...
                                <span v-if="plan.yearly_discount > 0" class="text-emerald-600">
                                    ({{ plan.yearly_discount }}% خصم)
                                </span>
                            </p>
                        </div>
                        ...
                        <div class="mt-6 flex gap-2">
                            <button
                                ...
                                class="flex-1 text-center px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium"
                            >
                                تعديل
                            </button>
                            <button
                                @click="deletePlan(plan)"
                                class="px-4 py-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg text-sm"
                            >
                                حذف
                            </button>
                        </div>
                ...
                <div
                    v-if="!plans?.length"
                    class="col-span-full text-center py-12 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700"
                >
                    <svg
        ...
        <Transition name="modal">
            <div v-if="showModal" class="fixed inset-0 z-50 overflow-y-auto">
                ...
                >
                    ...
                    <!-- Modal Panel -->
                    <div
                        class="relative bg-white dark:bg-gray-800 rounded-2xl text-start overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-2xl sm:w-full"
                    >
                        <!-- Header -->
                        <div
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            v-model.number="form.limits.max_centers"
                                            type="number"
                                            min="1"
                                            class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <input
                                            v-model.number="form.limits.storage_gb"
                                            type="number"
                                            min="1"
                                            class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                        />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    >
                                        مميزات الباقة (بالعربية)
                                    </h4>
                                    <div class="space-y-2">
                                        <div
                                            v-for="(feature, index) in form.features_ar"
                                            :key="'ar-' + index"
                                            class="flex gap-2"
                                        >
                                            <input
                                                v-model="form.features_ar[index]"
                                                type="text"
                                                class="flex-1 px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-950 dark:text-white"
                                                :placeholder="'ميزة عربية ' + (index + 1)"
                                            />
                                            <button
                                                @click="form.features_ar.splice(index, 1)"
                                                type="button"
                                ...
                                <div>
                                    <h4
                                        class="text-sm font-medium text-gray-900 dark:text-white mb-3"
                                    >
                                        مميزات الباقة (بالإنجليزية)
                                    </h4>
                                    <div class="space-y-2">
                                        <div
                                            v-for="(feature, index) in form.features_en"
                                            :key="'en-' + index"
                                            class="flex gap-2"
                                        >
                                            <input
                                                v-model="form.features_en[index]"
                                                type="text"
                                                class="flex-1 px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-950 dark:text-white"
                                                :placeholder="'English Feature ' + (index + 1)"
                                            />
                                            <button
                                                @click="form.features_en.splice(index, 1)"
                                                type="button"
                                                class="px-3 py-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg"
                                            >
                                                ✕
                        ...
                        >
                            ...
                            <button
                                ...
                                class="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium disabled:opacity-50"
                            >
