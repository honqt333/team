    ...
    <AppLayout>
        <div class="space-y-6">
            ...
            <div v-if="departments.length === 0 && unassignedServices.length === 0"
                ...
                <p class="text-lg font-medium text-gray-900 dark:text-white mb-1">{{ $t('services_management.empty') }}
                </p>
            ...
            <div v-else class="space-y-4">
                ...
                <div v-for="dept in filteredDepartments" :key="dept.id"
                    ...
                    <div
                        ...
                        <button @click="toggleDepartment(dept.id)" class="flex items-center gap-3 flex-1">
                            ...
                            <div class="text-start">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ dept.services?.length || 0 }} {{
                    ...
                    <div v-if="expandedDepts.has(dept.id)" class="border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div v-else class="divide-y divide-gray-100 dark:divide-gray-700">
                            <div v-for="service in dept.services" :key="service.id"
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-8 h-8 rounded-lg flex items-center justify-center"
                                        ...
                                        <svg v-if="service.type === 'internal'" class="w-4 h-4" fill="none"
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2">
                                            <span class="font-medium text-gray-900 dark:text-white">{{ getName(service)
                                                }}</span>
                                ...
                                <div class="flex items-center gap-2">
                                    <button @click.stop="toggleServiceActive(service)" :class="service.is_active
                ...
                <div v-if="unassignedServices.length > 0"
                    ...
                    <button @click="toggleDepartment('unassigned')"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-start">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ unassignedServices.length }} {{
                                    $t('services_management.services') }}</p>
                            </div>
                        </div>
                    ...
                    <div v-if="expandedDepts.has('unassigned')"
                        ...
                        <div v-for="service in unassignedServices" :key="service.id"
                            class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-colors">
                            <div class="flex items-center gap-4">
                                <div
