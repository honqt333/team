            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $t('company_profile.branches.title') }}</h1>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="p-6 space-y-4">
                    ...
                    <div v-if="props.branches?.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        >
                            <div class="flex items-start justify-between mb-4">
                                <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center text-white text-lg font-bold shadow-lg shadow-blue-500/20">
                            ...
                            <!-- Center Type -->
                            <p class="text-sm font-medium text-blue-600 dark:text-blue-400 mb-2">{{ branch.center_type || '#' }}</p>

                            <!-- Manager Name -->
                            <div v-if="branch.manager_name" class="flex items-center gap-2 mb-3 text-xs text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-700/50 p-1.5 rounded-lg border border-gray-100 dark:border-gray-700/50">
                            ...
                            <div class="space-y-1.5 mb-4">
                                <div v-if="branch.phone" class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                    <span dir="ltr">{{ branch.phone }}</span>
                                </div>
                                <div v-if="branch.email" class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <!-- System ID & Action -->
                            <div class="flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-3 mt-auto">
                    ...
                    <div v-else class="p-12 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ $t('company_profile.branches.empty') }}</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('company_profile.branches.empty_hint') }}</p>
                    </div>
                    ...
                    <div class="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800">
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-sm text-amber-700 dark:text-amber-300">{{ $t('company_profile.branches.coming_soon') }}</p>
                        </div>
                    </div>
                </div>
            </div>
