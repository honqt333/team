    ...
    <AppLayout>
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-12 text-center shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">قريباً.. متجر الإضافات والتكاملات</h3>
                <p class="text-gray-500 dark:text-gray-400 max-w-lg mx-auto">
                    ستتمكن هنا من تفعيل بوابات الدفع الإلكتروني، خدمات رسائل الواتساب والـ SMS، خدمات الدفع بالتقسيط (تابي/تمارا)، والربط مع خرائط جوجل وغيرها من الخدمات.
                </p>
            </div>
        </div>
    </AppLayout>
