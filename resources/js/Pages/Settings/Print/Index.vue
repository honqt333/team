            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <Link href="/app/settings" class="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $t('settings.cards.print.title') }}</h1>
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('settings.cards.print.description') }}</p>
                        </div>
                    </div>
                    
                    <button @click="save()" :disabled="form.processing" class="px-8 py-2.5 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold rounded-xl transition-all shadow-lg shadow-amber-500/20 disabled:opacity-50 hover:scale-105 active:scale-95 flex items-center gap-2">
