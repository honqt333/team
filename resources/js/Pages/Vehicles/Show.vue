<template>
    <AppLayout>
        <div class="space-y-4">
            ...
            <div
                ...
                <div
                    ...
                    <button v-if="can('quotes.create')" @click="openQuoteModal"
                    ...
                    <button v-if="can('crm.vehicles.delete')" @click="confirmDelete" :disabled="!canDelete" :class="[
                ...
                <div class="p-6">
                    ...
                    <div v-if="activeTab === 'mileage'" class="space-y-4">
                        <VehicleMileageList :vehicle-id="vehicle.id" />
                    </div>
        ...
        <!-- Modals -->
        <VehicleFormModal v-if="showEditModal" :show="showEditModal" :vehicle="vehicle" :customers="customersList"
            :makes="makes" :colors="colors" :modelsByMake="modelsByMake" @close="showEditModal = false"
            @saved="handleVehicleSaved" />

        <WorkOrderFormModal v-if="showWorkOrderModal" :show="showWorkOrderModal" :vehicle="vehicle"
            :customers="customersList" :makes="makes" :colors="colors" :modelsByMake="modelsByMake"
            :departments="departments" @close="showWorkOrderModal = false" @saved="handleWorkOrderSaved" />

        <QuoteFormModal v-if="showQuoteModal" :show="showQuoteModal" :vehicle="vehicle" :customers="customersList"
            :makes="makes" :colors="colors" :modelsByMake="modelsByMake" :departments="departments" :services="services"
...
import VehicleMileageList from '@/Components/Vehicles/VehicleMileageList.vue';
...
const MileageIcon = () => h('svg', { class: 'w-4 h-4', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M13 10V3L4 14h7v7l9-11h-7z' })]);
...
const tabs = computed(() => [
    ...
    { key: 'mileage', label: t('vehicles.mileage.history'), count: props.counts.mileageLogs, icon: MileageIcon, activeColor: 'text-blue-600 dark:text-blue-400' },
