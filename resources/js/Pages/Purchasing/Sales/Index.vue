                            ...
                            <table class="w-full min-w-[800px] divide-y divide-gray-100 dark:divide-gray-700/50">
                                ...
                                <tbody class="divide-y divide-gray-50 dark:divide-gray-700/30">
                                    <tr v-for="(invoice, index) in invoices.data" :key="invoice.id"
                                        ...
                                        <!-- تاريخ الفاتورة -->
                                        <td
                                            class="px-4 py-4 text-center text-sm text-gray-600 dark:text-gray-300 font-mono">
                                        ...
                                        <!-- المجموع -->
                                        <td class="px-4 py-4 text-center text-sm font-bold text-gray-900 dark:text-white font-mono"
                                            dir="ltr">
                                            {{ formatCurrency(getGrossTotal(invoice)) }}
                                        </td>

                                        <!-- الخصم -->
                                        <td class="px-4 py-4 text-center text-sm font-medium text-rose-600 dark:text-rose-400 font-mono"
                                            dir="ltr">
                                        ...
                                        <!-- VAT -->
                                        <td class="px-4 py-4 text-center text-sm font-medium text-gray-500 dark:text-gray-400 font-mono"
                                            dir="ltr">
                                            {{ formatCurrency(invoice.total_tax) }}
                                        </td>

                                        <!-- مبلغ الفاتورة -->
                                        <td class="px-4 py-4 text-center text-sm font-black text-gray-900 dark:text-white font-mono"
                                            dir="ltr">
                                            {{ formatCurrency(invoice.total_incl_tax) }}
                                        </td>

                                        <!-- الباقي -->
                                        <td class="px-4 py-4 text-center text-sm font-bold font-mono" dir="ltr"
