<template>
    <AppLayout>
        <div class="space-y-6">
            ...
            >
                ...
                <template #actions>
                    ...
                    >
                        <div
                            class="w-7 h-7 rounded-lg bg-white/20 flex items-center justify-center group-hover/add:rotate-90 transition-transform duration-300"
                        >
                            <svg
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead class="bg-gray-50 dark:bg-gray-700/50">
                                <tr>
                                    <th
                                        class="px-6 py-4 text-start font-medium text-gray-600 dark:text-gray-300 align-middle text-center"
                                    >
                                        {{ $t('hr.payroll.period') }}
                                    </th>
                                    <th
                                        class="px-6 py-4 text-center font-medium text-gray-600 dark:text-gray-300 align-middle"
                                    >
                                        {{ $t('hr.payroll.employees_count') }}
                                    </th>
                                    <th
                                        class="px-6 py-4 text-center font-medium text-gray-600 dark:text-gray-300 align-middle"
                                    >
                                        {{ $t('hr.payroll.total_net') }}
                                    </th>
                                    <th
                                        class="px-6 py-4 text-center font-medium text-gray-600 dark:text-gray-300 align-middle"
                                    >
                                    ...
                                    <th
                                        class="px-6 py-4 text-end font-medium text-gray-600 dark:text-gray-300 align-middle text-center"
                                    >
                                        {{ $t('common.actions') }}
                                    </th>
                                </tr>
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-center align-middle">
                                        <div class="flex items-center justify-center gap-2">
                                            <div
                                                class="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-[10px] font-bold text-gray-500"
                                            >
                                    ...
                                    <td class="px-6 py-4 align-middle">
                                        <div
                                            class="flex items-center justify-end gap-1.5 p-1 bg-gray-50/50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-700/50 w-fit ms-auto"
                                        >
                                            <Link
                                ...
                                <tr v-if="!payrollRuns.data?.length">
                                    <td
                                        colspan="6"
                                        class="px-6 py-12 text-center text-gray-500 dark:text-gray-400 align-middle"
                                    >
        ...
        <BaseModal
            ...
            :title="$t('hr.payroll.generate')"
        >
            <form @submit.prevent="generatePayroll" class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label
                            class="block text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 px-1"
                        >
...
function formatCurrency(amount) {
    return new Intl.NumberFormat('ar-SA-u-nu-latn', { style: 'currency', currency: 'SAR' }).format(
        amount
    );
}
...
function getStatusClass(status) {
    switch (status) {
        case 'draft':
            return 'bg-orange-50 text-orange-700 border-orange-100 dark:bg-orange-900/30 dark:text-orange-400 dark:border-orange-800/30';
        case 'approved':
