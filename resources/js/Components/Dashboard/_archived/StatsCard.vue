...
<template>
    ...
    >
        ...
        <div class="relative flex items-start justify-between gap-4">
            ...
            <div
                :class="[
                    'w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm ring-1',
                    c.iconBg,
                    c.ring,
                ]"
            >
        ...
        <div
            v-if="previousValue !== null && !loading"
            class="relative mt-4 pt-3 border-t border-gray-100 dark:border-gray-700/50"
        >
