<template>
        ...
        <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <div class="md:col-span-6">
                        ...
                        <SearchableSelect
                            ...
                            option-label="name"
                            option-value="id"
                            :placeholder="$t('purchasing.orders.select_supplier')"
                            class="w-full"
                            required
                        />
                        <div v-if="form.errors.supplier_id" class="text-red-500 text-xs mt-1">
                    ...
                    <div class="md:col-span-3">
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
                        >
                            {{ $t('purchasing.orders.date') }}
                            <span class="text-red-500">*</span>
                        </label>
                        <CustomDatePicker
                            v-model="form.order_date"
                            :placeholder="$t('purchasing.orders.date')"
                        />
                    </div>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <CustomDatePicker
                            ...
                            :placeholder="$t('purchasing.orders.expected_date')"
                        />
                    </div>
                ...
                >
                    <table class="w-full text-sm">
                        ...
                        >
                            <tr>
                                <th
                                    class="px-4 py-3 text-center font-medium bg-gray-50 dark:bg-gray-800/50 w-12"
                                >
                                    #
                                </th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            >
                                <td
                                    class="px-4 py-3 text-center text-gray-400 font-mono"
                                    dir="ltr"
                                    lang="en"
                                >
                                    {{ index + 1 }}
                                ...
                                <td
                                    class="px-4 py-3 text-center font-mono text-gray-600 dark:text-gray-300"
                                    dir="ltr"
                                    lang="en"
                                    style="font-family: 'Inter', system-ui, sans-serif !important"
                                >
                                ...
                                <td
                                    class="px-4 py-3 text-center font-mono font-bold text-gray-900 dark:text-white"
                                    dir="ltr"
                                    lang="en"
                                    style="font-family: 'Inter', system-ui, sans-serif !important"
                                >
            ...
            <div class="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-green-50 dark:bg-green-900/20 flex items-center justify-center"
                        >
                ...
                >
                    <table class="w-full text-sm">
                        ...
                        >
                            <tr>
                                <th
                                    class="px-4 py-3 text-center w-12 text-xs uppercase tracking-widest font-black"
                                >
                                    #
                                </th>
                                <th
                                    class="px-4 py-3 text-center text-xs uppercase tracking-widest font-black"
                                >
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            >
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span
                                        class="inline-flex px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border border-blue-100/50 dark:border-blue-800/30"
                                    >
                                        {{ $t(`payments.methods.${payment.payment_method}`) }}
                                    </span>
                                </td>
                                <td
                                    class="px-4 py-3 text-center text-gray-600 dark:text-gray-400 font-mono"
                                    dir="ltr"
                                    lang="en"
                                >
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    >
                                        <button
                                            type="button"
                                            @click="openPaymentModal(payment, index)"
                                            class="p-1 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                        >
                                            <svg
                                                class="w-4 h-4"
                ...
                <div
                    v-else
                    class="text-center py-8 bg-gray-50/50 dark:bg-gray-900/30 rounded-2xl border border-dashed border-gray-200 dark:border-gray-700"
                >
            ...
            <div class="flex justify-end pt-2">
                ...
                >
                    ...
                    >
                        {{ $t('purchasing.orders.balance') }}
                    </span>
                    <span
                        class="text-3xl font-bold"
                        :class="{
                            'text-green-600 dark:text-green-400': remainingBalance === 0,
                            'text-red-500 dark:text-red-400': remainingBalance > 0,
                        }"
                        dir="ltr"
                        lang="en"
                    >
            ...
            >
                <div
                    class="flex items-center justify-between bg-blue-50/50 dark:bg-blue-900/10 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/30"
                >
                    <div class="flex items-center gap-3">
                        <div
                        ...
                        <div>
                            <h3 class="text-base font-bold text-gray-900 dark:text-white">
                                {{ $t('purchasing.orders.create_credit_invoice') }}
                            </h3>
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                {{ $t('purchasing.orders.credit_invoice_hint') }}
                            </p>
                        </div>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input
                            type="checkbox"
                            v-model="form.create_credit_invoice"
                            class="sr-only peer"
                        />
                        <div
                ...
                <div
                    v-if="form.create_credit_invoice"
                    class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm animate-in fade-in slide-in-from-top-2 duration-300"
                >
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
                        >
                            {{ $t('purchasing.orders.due_date') }}
                            <span class="text-red-500">*</span>
                        </label>
                        <CustomDatePicker
                            v-model="form.due_date"
                            :placeholder="$t('purchasing.orders.due_date')"
                        />
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea
                    v-model="form.notes"
                    rows="3"
                    class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500"
                ></textarea>
            </div>
        </form>
        ...
        <template #footer>
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center gap-2">
                    <p
                        v-if="!isFormValid"
                        class="text-xs text-amber-600 dark:text-amber-400 font-bold bg-amber-50 dark:bg-amber-900/20 px-3 py-1.5 rounded-lg border border-amber-100 dark:border-amber-800/30"
                    >
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button
                        type="button"
                        @click="submit"
                        :disabled="!isFormValid || form.processing || submitting"
    ...
    <PurchaseOrderItemModal
        ...
        :item="editingItem"
        :units="units"
        v-model:tax-included="form.tax_included"
        :tenant-tax-settings="tenantTaxSettings"
    ...
    (newVal) => {
        if (newVal) {
            if (!props.order) {
                form.reset();
                form.warehouse_id =
                    props.defaultWarehouse?.id ||
                    (props.warehouses?.length > 0 ? props.warehouses[0].id : '');
...
const isFormValid = computed(() => {
    const basicFields =
        form.warehouse_id && form.supplier_id && form.supplier_reference && form.items.length > 0;
...
const submit = () => {
    ...
    if (form.payment_type === 'cash') {
        ...
        if (remainingBalance.value > 0.01) {
            ...
            form.setError(
                'payments',
                t('purchasing.orders.errors.full_payment_required') ||
                    'Full payment is required for Cash orders.'
            );
            return;
        }
    } else {
