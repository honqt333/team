        ...
        <form @submit.prevent="submitForm" class="space-y-4">
            ...
            <div class="min-h-[350px]">
                ...
                <div v-show="activeTab === 'main_info'" class="space-y-4">
                        ...
                        >
                            ...
                            >
                                <div :class="[
                                    ...
                                    <svg class="w-5 h-5" :class="vehicle.has_open_quote ? 'text-red-600' : 'text-gray-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path v-if="vehicle.has_open_quote" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    ...
                    <div v-if="selectedVehicle" class="relative bg-gradient-to-br from-amber-500/10 via-orange-500/10 to-red-500/10 dark:from-amber-900/30 dark:via-orange-900/20 dark:to-red-900/20 rounded-2xl p-5 border border-amber-300/50 dark:border-amber-700/50 overflow-hidden">
                        <!-- Decorative Background -->
                        <div class="absolute top-0 end-0 w-32 h-32 bg-gradient-to-br from-amber-400/20 to-orange-400/20 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2"></div>
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-amber-600 dark:text-amber-400">{{ selectedVehicle.plate_number }}</p>
                            </div>
                            <button
                                type="button"
