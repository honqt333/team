        ...
        <form @submit.prevent="submitForm" class="space-y-4">
            ...
            <div class="flex flex-wrap gap-1 bg-gray-100 dark:bg-gray-900 rounded-xl p-1">
                ...
                >
                    ...
                    <span class="text-[10px] sm:text-sm text-center leading-tight">
                        {{ tab.label }}
                    </span>
                </button>
            </div>
            ...
            <div class="min-h-[350px]">
                ...
                <div v-show="activeTab === 'main_info'" class="space-y-4">
                    ...
                    <div
                        v-if="!vehicle && (!quote || !selectedVehicle)"
                    ...
                    >
                        ...
                        <div class="relative">
                            ...
                            />
                            <svg
                                class="w-5 h-5 absolute start-3 top-1/2 -translate-y-1/2 text-gray-400"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                            ...
                            <div v-if="searching" class="absolute end-3 top-1/2 -translate-y-1/2">
                                <svg
                                    class="animate-spin w-5 h-5 text-amber-500"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                >
                                    <circle
                            ...
                            >
                                ...
                                <div class="flex-1">
                                    ...
                                    >
                                        ...
                                        >
                                            {{ $t('quotes.has_open_quote') }} ({{
                                                toEnglish(vehicle.open_quote?.code)
                                            }})
                                        </span>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        <div
                            class="bg-gray-50 dark:bg-gray-900/50 p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between"
                        >
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col">
                                    <span
                                        class="text-xs font-bold text-amber-600 dark:text-amber-400 uppercase tracking-wider"
                                    >
                                        {{ $t('common.selected') }}
                                    </span>
                                    <h4
                        ...
                        <div class="p-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center gap-3 group/item">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span
                                            class="text-sm font-semibold text-gray-700 dark:text-gray-300 font-mono"
                                        >
                                            {{ selectedVehicle.vin || '—' }}
                                        </span>
                                    </div>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="flex items-center gap-2 group/item">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            >
                                                {{ toEnglish(selectedVehicle.year) || '—' }}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-2 group/item">
                                        <div
                                            class="w-8 h-8 rounded-lg bg-rose-50 dark:bg-rose-900/30 flex items-center justify-center text-rose-600 dark:text-rose-400"
                                        >
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="flex items-center gap-1.5">
                                                <span
                                                    ...
                                                    class="w-2.5 h-2.5 rounded-full border border-gray-300 dark:border-gray-600 shadow-sm"
                                                    :style="{
                            ...
                            <div
                                class="space-y-3 pt-4 sm:pt-0 sm:ps-4 sm:border-s border-gray-100 dark:border-gray-700"
                            >
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm shadow-sm ring-2 ring-white dark:ring-gray-800"
                                    >
                                        {{
                                            selectedVehicle.customer?.name?.[0]?.toUpperCase() ||
                                            'C'
                                        }}
                                    </div>
                                    <div class="flex flex-col min-w-0">
                                        <span
                                            class="text-[10px] font-bold text-gray-400 uppercase tracking-widest"
                                        >
                                            {{ $t('quotes.form_tabs.customer_name') }}
                                        </span>
                                        <span
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span
                                            ...
                                            dir="ltr"
                                        >
                                            {{ toEnglish(selectedVehicle.customer?.phone) }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            <div class="flex items-center gap-3">
                                <!-- Allow Lower Toggle -->
                                <label
                                    v-if="selectedVehicle && lastVehicleOdometer > 0"
                                    class="flex items-center gap-2 cursor-pointer group"
                                >
                                    <div class="relative">
                                        <input
                                            type="checkbox"
                                            v-model="form.allow_lower_odometer"
                                            class="sr-only peer"
                                        />
                                        <div
                                            class="w-8 h-4 bg-gray-200 dark:bg-gray-700 rounded-full peer peer-checked:bg-amber-500 transition-all after:content-[''] after:absolute after:top-0.5 after:start-0.5 after:bg-white after:rounded-full after:h-3 after:w-3 after:transition-all peer-checked:after:translate-x-4 rtl:peer-checked:after:-translate-x-4"
                                        ></div>
                                    </div>
                                    <span
                                        class="text-[10px] font-bold text-gray-500 group-hover:text-amber-600 transition-colors uppercase tracking-wider"
                                    >
                        ...
                        <div class="relative">
                            <input
                                ...
                                inputmode="numeric"
                                @input="
                                    form.odometer = toEnglish($event.target.value).replace(
                                        /[^0-9]/g,
                                        ''
                                    )
                                "
                        ...
                        >
                            ...
                            <span>
                                {{
                                    $t('vehicles.mileage.lower_warning', {
                                        last: toEnglish(lastVehicleOdometer),
                                    })
                                }}
                            </span>
                        </div>
                        ...
                        <!-- Hint for last known -->
                        <div
                            v-else-if="selectedVehicle && lastVehicleOdometer > 0"
                        ...
                        >
                            ...
                            {{ $t('vehicles.mileage.last_recorded') }}:
                            {{ toEnglish(lastVehicleOdometer) }} km
                        </div>
                    </div>
                </div>
                ...
                <div v-show="activeTab === 'customer_complaint'" class="space-y-4">
                    ...
                    >
                        ...
                        <textarea
                            ...
                            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 resize-none"
                        ></textarea>
                    </div>
                </div>
                ...
                <div v-show="activeTab === 'departments'" class="space-y-4">
                    ...
                    >
                        ...
                        <div class="space-y-2">
                            <label
                                v-for="(dept, index) in availableDepartmentsList"
                                :key="dept.id"
                            ...
                            >
                                ...
                                <span class="text-gray-900 dark:text-white">
                                    {{ toEnglish(index + 1) }}. {{ toEnglish(getName(dept)) }}
                                </span>
                            </label>
                        </div>
                    </div>
        ...
        <template #footer>
            ...
            <button
                ...
                :disabled="
                    form.processing ||
                    !selectedVehicle ||
                    (showOdometerWarning && !form.allow_lower_odometer)
                "
...
const IconInfo = (props, { attrs }) =>
    h('svg', { ...attrs, fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
        h('path', {
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
            'stroke-width': '2',
...
const IconComplaint = (props, { attrs }) =>
    h('svg', { ...attrs, fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
        h('path', {
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
...
const IconAssessment = (props, { attrs }) =>
    h('svg', { ...attrs, fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
        h('path', {
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
...
const IconDepartments = (props, { attrs }) =>
    h('svg', { ...attrs, fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
        h('path', {
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
...
const IconColor = (props, { attrs }) =>
    h('svg', { ...attrs, fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
        h('path', {
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
            'stroke-width': '2',
            d: 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.828 2.828a2 2 0 010 2.828l-8.486 8.486',
        }),
    ]);
const IconYear = (props, { attrs }) =>
    h('svg', { ...attrs, fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
        h('path', {
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
    ...
    router.reload({
        ...
        onSuccess: async () => {
            ...
            window.dispatchEvent(
                new CustomEvent('customer-reloaded', {
...
function submitForm() {
    ...
    const url = isEdit ? `/app/quotes/${props.quote.id}` : '/app/quotes';
