        ...
        return Inertia::render('Quotes/PublicShow', [
            'quote' => [
                ...
                'center' => $quote->center ? [
                    ...
                    'logo_invoice_url'=> $quote->center->logo_invoice_url,
                    'stamp_url'      => $quote->center->stamp_url,
                    'vat_number'     => $quote->center->vat_number,
                    'address'        => $quote->center->address,
                ] : null,
                'tenant' => $quote->tenant ? [
                    'quote_title'    => $quote->tenant->quote_title,
                    'quote_terms'    => $quote->tenant->quote_terms,
                    'vat_number'     => $quote->tenant->vat_number,
                    'cr_number'      => $quote->tenant->cr_number,
                    'phone'          => $quote->tenant->phone,
                    'logo_url'       => $quote->tenant->logo_url,
                    'iban'           => $quote->tenant->iban,
                    'address'        => $quote->tenant->address,
                    'print_settings' => $quote->tenant->print_settings,
                ] : null,
                'customer' => $quote->customer ? [
                    'id'           => $quote->customer->id,
                    'name'         => $quote->customer->name,
                    'phone'        => $quote->customer->phone,
                    'address_line' => $quote->customer->address_line,
                    'tax_number'   => $quote->customer->tax_number,
                ] : null,
                ...
                'parts' => $quote->parts->map(fn($part) => [
                    ...
                    'tax_rate_snapshot' => $part->tax_rate_snapshot,
                ]),
            ],
        ]);
    }
